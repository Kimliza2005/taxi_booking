...
const App = () => {
    ...
    const Menus = [
        ...
        { title: "Earnings", icon: <FaMoneyBillWave /> },
            ...
            <div className="h-screen flex-1 bg-zinc-100 space-y-6">
                ...
                <div className="w-full h-[8ch] px-12 bg-zinc-50 shadow-md flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-x-8">
                        ...
                        {/* Profile img */}
                        <img src="https://i.pinimg.com/originals/64/f0/d3/64f0d39d98ca065c3654a58e7c4caa06.jpg" alt="profile img" className="w-11 h-11 rounded-full object-cover object-center cursor-pointer" />
                    </div>
                </div>
